...
// Api
$api = new Api(true);
$api->token = 'D9xss5mgYaIA9HLMsx6z04YbmtOBcVaY_zqNBEh9Xjnj_yDDNo0HeaqXUn1emdnVN6dGQL4eusjAT3sI_7Q=';
...
{
    $a_name = str_to_noaccent($a['name']);
    $b_name = str_to_noaccent($b['name']);
